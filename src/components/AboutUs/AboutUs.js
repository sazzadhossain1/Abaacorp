...
const AboutUs = () => {
  return (
    <div className="about_parent_div">
      <div className="aboutUs_grid_div">
        <div className="aboutUs_text_div">
          ...
          <p>
            ...
            Website Design & Development, Graphic Design, Video Editing as well
            as Digital Marketing Services along with Search Engine Optimization.
          </p>
          <p>
